<script lang="ts">
  ...
  export let assignee: User | null = null;
...
<div class="space-y-0.5">
  ...
  <div class="relative w-full">
    ...
    <div
      ...
      class="absolute top-0 right-1 -translate-x-full w-full z-10 p-1 pt-0 bg-white border rounded"
    >
      <input
        type="text"
        bind:value={username}
        placeholder="Assign to..."
        class="w-full px-4 h-10 border-none outline-none focus:outline-none focus:ring-0"
      />
